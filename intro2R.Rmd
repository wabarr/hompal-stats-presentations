...
<img width='100px' src="images/intro2R/hello.png"/>
...
What kind of data is contained in the 'badnews' vector?

Answer: Text data  

Only one kind of data can exist in an atomic vector, so R converts everything to text. 
...
<img src="images/intro2R/hickory.png"/>
