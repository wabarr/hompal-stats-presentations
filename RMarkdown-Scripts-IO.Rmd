...
Notice that the file name is the complete path to the file on your computer (this could also be a complete URL for a file that lives on the inter-tubes)  You can use the ~ character as a shortcut to your home directory on Windows or Mac. 
