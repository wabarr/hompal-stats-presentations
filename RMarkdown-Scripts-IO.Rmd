...
R is like the lenses and mirrors.  R is the command line interpreter that does the actual statistical work.
...
R Studio helpfully shows you the variables currently definted in the "Environment" tab.
...
> 4.  Save your script file somewhere you can find it, then clear your workspace to delete ALL saved variables, and re-run your script file to redo all the steps.
